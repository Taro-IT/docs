...
Si el producto de trabajo a verificar es el primero que se verifica de su historia de usuario, se deberá hacer una copia de la hoja original de la <a href="https://taro-it.github.io/docs/checklists/CH02-checklist-items-trabajo">checklist de productos de trabajo</a> del equipo correspondiente y nombrarla con el identificador de la historia.
    ...
    <tr>
      ...
      <td>
        <ul align="left">
          ...
          <li>Duplicar la <a href="https://taro-it.github.io/docs/checklists/CH02-checklist-items-trabajo">checklist de productos de trabajo</a> (la copia de la checklist se quedará como una nueva pestaña dentro del mismo archivo) correspondiente al equipo y nombrarla con el identificador de la historia de usuario relacionada al item.</li>
          ...
          <ul>
            ...
            <li>Si es código, a un PR en el repositorio del equipo de acuerdo a la <a href="https://taro-it.github.io/docs/guias/G12-guia-para-manejo-de-ramas">guía para manejo de ramas</a> y la <a href="https://taro-it.github.io/docs/guias/G18-guia-pull-request">guía para realizar un pull request</a>.</li>
    ...
    <tr>
      ...
      <td>
        <ul align="left">
          ...
          <li>Abrir la <a href="https://taro-it.github.io/docs/checklists/CH02-checklist-items-trabajo">checklist de items de trabajo</a> y buscar la copia para el caso que tendrá el nombre del identificador de la historia de usuario relacionada al item.</li>
          ...
          <li>Si el producto no cumple con un elemento:
            <ul>
                ...
                <li>Si el producto es código, registrar el incumplimiento en el defect log usando la <a href="https://taro-it.github.io/docs/guias/G16-guia-registrar-defectos">guía  para el defect log</a>.</li>
    ...
    <tr>
      ...
      <td>
        <ul align="left">
          ...
          <li>Si el item es código, completar el PR haciendo el merge a dev y borrando la rama en la que se trabajaron los cambios. Basarse en la <a href="https://taro-it.github.io/docs/guias/G18-guia-pull-request">guía para realizar un pull request</a>.</li>
...
- Pull request aprobado listo para [liberación](https://taro-it.github.io/docs/procesos/P23-proceso-release-linea-base).
