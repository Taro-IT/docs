...
| 5. Revisar estado de la iteración. | <ul><li>La persona con el rol de Team Leader muestra el progreso del sprint, el CPI, el SPI y la efectividad diaria para mostrar el estado de la iteración</li><li>Si hubo progreso y/o mejora se felicita al equipo. De lo contrario se toman decisiones para corregir las desviaciones encontradas en el plan de la iteración.</li></ul> | <ul><li>PMC - 1.1</li><li>PMC - 1.4</li><li>PMC - 1.6</li><li>MandA - 2.2</li><li>MandA - 2.4</li></ul> |
